...
#define FLEAMAN_ANI_JUMP_RIGHT	2
#define FLEAMAN_ANI_JUMP_LEFT	3
#define FLEAMAN_ANI_PREATTACK	4
#define FLEAMAN_ANI_IDLE_RIGHT	5
#define FLEAMAN_ANI_IDLE_LEFT	6
